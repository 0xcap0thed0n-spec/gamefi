    ...
    <div className={"relative " + className}>
      ...
      {clicked ? (
        <p
          ...
          role="status"
        >
          Wallet connect is coming soon on{" "}
          <strong className="text-neon-cyan">Base testnet</strong> with
          MetaMask. This button is a placeholder — nothing is connected yet.
          <button
            type="button"
